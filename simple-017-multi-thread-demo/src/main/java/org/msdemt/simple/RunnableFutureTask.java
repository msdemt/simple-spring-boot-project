...
public class RunnableFutureTask {
    ...
    static void futureDemo() {
        try {
            ...
            System.out.println("future result from Thread FutureTask5 :" + result5.get());    //call()有返回值，result5.get()方法会阻塞

            FutureTask<Integer> result6 = new FutureTask<Integer>(new Callable<Integer>() {
                public Integer call() throws Exception {
                    return fibc(20);
                }
            });
            new Thread(result6).start();
            System.out.println("future result from Thread FutureTask6 :" + result6.get());    //call()有返回值，result6.get()方法会阻塞
